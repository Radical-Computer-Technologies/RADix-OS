...
#define RAD_KERNEL_HAS_PICO_DMA 1
#else
#define RAD_KERNEL_HAS_PICO_DMA 0
#endif
#define RAD_KERNEL_HAS_PICO_SDK 1
#else
#define RAD_KERNEL_HAS_PICO_SDK 0
#define RAD_KERNEL_HAS_PICO_DMA 0
#endif

namespace {
#if RAD_KERNEL_HAS_PICO_SDK
...
#if RAD_KERNEL_ENABLE_RP2350_HSTX_DVI
